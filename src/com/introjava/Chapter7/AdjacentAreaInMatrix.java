...
//                }
    ...
    // I think the problem is that you are resetting the tempElementsCount every time.
    // Just imagine how your code would work on the given matrix and you'll see that you in the runDFS() method
    // you always start the search with element (0, 0) for which the if clause will be false,
    // so you reset tempElementsCount before you could continue the search with the other (and probably adjacent) elements.
}